    ...
    <header className="bg-surface border-b border-outline-variant w-full sticky top-0 z-50">
      <div className="flex justify-between items-center w-full px-lg py-md max-w-container-max mx-auto">
        ...
        <nav className="hidden md:flex items-center gap-lg">
          <a
            href="https://github.com/TheGuyCheese/linkChecker"
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-1.5 text-body-md text-on-surface-variant hover:text-primary transition-colors duration-200"
          >
